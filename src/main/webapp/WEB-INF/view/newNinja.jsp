...
<head>
	...
	<title>NinjaDojos Roster | New Ninja</title>
</head>
<body>
	<section class="add-form mt-5">
		...
		<div class="d-flex justify-content-center align-items-center container">
			<form:form class="form-horizontal" action="/addNinja" method="post" modelAttribute="ninja">
		
				<div class="form-group row">
					<label for=dojo class="col-sm-4 col-form-label">Dojo</label>
					<div class="col-sm-8">
						<form:select path="dojo" class="custom-select"> 
